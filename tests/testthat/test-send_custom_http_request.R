test_that("send_custom_http_request()", {
  get_request <- send_custom_http_request(
  ...
  post_request <- send_custom_http_request(
  ...
  put_request <- send_custom_http_request(
  ...
  delete_request <- send_custom_http_request(
  ...
  header_request <- send_custom_http_request(
  ...
  query_params <- send_custom_http_request(
    "https://httpbin.org/get",
    "GET",
    list(),
    list(test_1 = "Hallo", test_2 = "Hallo 1", test_3 = "Hallo 3"),
  ...
  form_params <- send_custom_http_request(
    "https://httpbin.org/get",
    "GET",
    list(),
    list(),
